...
var Element = document.querySelector('.nav-info h1');
var favAndThemeBtn = document.querySelector('.favAndTheme-btn');
...
Element.addEventListener('click', function () {
    favAndThemeBtn.style.display = 'flex';

    setTimeout(function () {
        favAndThemeBtn.style.display = 'none';
    }, 2000)
});
